...
const EXTREME_NOTES = {
    ...
    COMPU5MUSA: { high: 'Apartments are being finished at a rate rarely seen. New supply is what actually slows rent growth, and 2024 saw the most completions since 1974, alongside rent inflation falling from 8.3% to under 3%.', low: 'Very little new supply arriving, which historically let rents run.',
        playHigh: 'Textbook: heavy completions favour renters and squeeze landlord pricing power, concentrated in whichever metros did the building. Watch starts for what comes next, because completions follow starts by about two years.', playLow: 'Textbook: thin supply has historically meant rent growth reaccelerating with a lag.' },
    HOUST5F: { low: 'Few apartments are being started, which sets supply roughly two years out. Weak starts today are the reason for a rent squeeze later, long after everyone has stopped talking about it.', high: 'Heavy building underway; the supply lands in about two years.',
        playLow: 'Textbook: a thin pipeline is the leading indicator for the next round of rent pressure, and it usually appears while rent inflation still looks tame.', playHigh: 'Textbook: a full pipeline caps future rent growth in the metros doing the building.' },
    ...
    A006RE1Q156NBEA: { low: 'A small share of the economy is going into building things: factories, equipment, housing. Historically that meant slower future growth, and it is one of the fingerprints of capital preferring existing assets over new ones.', high: 'Heavy investment in productive capacity, which historically supported future growth but sometimes built the overcapacity behind the next bust.',
        playLow: 'Textbook: when capital buys existing assets rather than building new ones, asset prices rise faster than the economy does, which is how prices detach from earnings.', playHigh: 'Textbook: investment booms supported industrials and materials, until the capacity turned out to be too much.' },
    WFRBSTP1300: { high: 'The wealthiest 1 in 1,000 households hold a near-record share of everything. This is the sharpest end of concentration and it moves before the broader top-1% number does.', low: 'Concentration at the very top unusually low.',
        playHigh: 'Textbook: at this end of the distribution, spending is almost entirely discretionary and driven by asset prices, so the wealth effect dominates and the political response becomes a live risk.', playLow: 'Textbook: broader-based ownership historically meant more stable consumption.' },
